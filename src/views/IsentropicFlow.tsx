    ...
    return (
        <div>
            <Table>
                <Table.Body>
                    <Table.Row>
                        <Table.HeaderCell> Mach : </Table.HeaderCell>
                        <Table.Cell> {flow.Mach} </Table.Cell>
                        <Table.HeaderCell> Pressure Ratio : </Table.HeaderCell>
                        <Table.Cell> {flow.PressureRatio.toFixed(3)} </Table.Cell>
                        <Table.HeaderCell> Temperature Ratio : </Table.HeaderCell>
                        <Table.Cell> {flow.TemperatureRatio.toFixed(3)} </Table.Cell>
                    </Table.Row>
                    <Table.Row>
                        <Table.HeaderCell> Temperature : </Table.HeaderCell>
                        <Table.Cell> {flow.Temp.toFixed(3)} </Table.Cell>
                        <Table.HeaderCell> Sound Speed : </Table.HeaderCell>
                        <Table.Cell> {flow.SoundSpeed.toFixed(3)} </Table.Cell>
                        <Table.HeaderCell> Velocity : </Table.HeaderCell>
                        <Table.Cell> {flow.Velocity.toFixed(3)} </Table.Cell>
                    </Table.Row>
                    <Table.Row>
                        <Table.HeaderCell> Temperature : </Table.HeaderCell>
                        <Table.Cell> {flow.Temp.toFixed(3)} </Table.Cell>
